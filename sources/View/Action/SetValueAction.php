 ...
 */
class SetValueAction extends AbstractAction implements ViewActionInterface
{
	private $_label;
	private $_value;
	private $_gender;
	 ...
	 */
	public function __construct(TranslatorInterface $translator, string $label, string $value, ?int $gender = null)
	{
	...
	public function getHtml(): string
	{
		...
		return $this->_trans('set_value.html', $params, $this->_gender);
	}
	...
	public function getText(): string
	{
		...
		return $this->_trans('set_value.text', $params, $this->_gender);
	}
}