 ...
 */
class PopItemAction extends AbstractAction implements ViewActionInterface
{
	private $_label;
	private $_value;
	private $_gender;
	...
	public function getHtml(): string
	{
		...
		return $this->_trans('pop_item.html', $params, $this->_gender);
	}
	...
	public function getText(): string
	{
		...
		return $this->_trans('pop_item.text', $params, $this->_gender);
	}
}