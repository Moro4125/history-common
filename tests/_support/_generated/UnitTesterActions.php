 ...
 */ //[STAMP] 0988291ddcfd9d1d5eeea4d096d01bca
...
trait UnitTesterActions
{
	...
	{
		return $this->getScenario()
			->runStep(new \Codeception\Step\Action('assertNotTrue', func_get_args()));
	}
	...
	{
		return $this->getScenario()
			->runStep(new \Codeception\Step\Action('assertNotFalse', func_get_args()));
	}
	...
	{
		return $this->getScenario()
			->runStep(new \Codeception\Step\Action('fail', func_get_args()));
	}
